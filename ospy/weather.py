...
class _Weather(Thread):
    ...
    def _find_location(self):
        if options.location and options.stormglass_key:
            ...
            if not data:
                ...
                logging.debug('Location found: %s, %s at %.1fm above sea level', self._lat, self._lon, self._elevation)
    ...
    def _deprecated(self, *args, **kwargs):
        raise Exception('This interface was removed, please update the plug-in!')
